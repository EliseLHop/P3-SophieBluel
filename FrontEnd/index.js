...
button.addEventListener('click', () => {
  galleryPhoto.style.display = 'none'; // Cacher l'élément

});

button.addEventListener('click', () => {
  ajoutPhoto.style.display = 'block'; // Montrer l'élément
...
async function postProject() {
   ...
   const formData = new FormData();
    ...
    formData.append("imageUrl", document.getElementById('ajouter-photo').files[0]);
...
document.getElementById("valider").addEventListener('click', () => {
  postProject()
  let fichier = document.getElementById("ajouter-photo")
  //console.log(fichier)
